...
import { decode, encode } from "https://deno.land/std/strings/mod.ts";
import { hasOwnProperty } from "https://deno.land/std/util/has_own_property.ts";

type Conn = Deno.Conn;
type Writer = Deno.Writer;
import { BufReader, BufWriter, UnexpectedEOFError } from "https://deno.land/std/io/bufio.ts";
import { readLong, readShort, sliceLongToBytes } from "https://deno.land/std/io/ioutil.ts";
import { Sha1 } from "https://deno.land/std/ws/sha1.ts";
import { writeResponse } from 'https://deno.land/std/http/server.ts';
